...
const string DFLT_CLIENT_ID         {"SmartCam_1_send"};
const string TOPIC_IMAGE            {"Camera_1"};
const string TOPIC_FEATURE          {"Feature_Camera_1"};
...
const string TOPIC_STREAM           {"stream_1"};
const string TOPIC_CROPPED_IMAGE    {"cropped_image"};
const string TOPIC_OK_SIGNAL        {"ok_signal"};
const string TOPIC_TOP_1_CAM2       {"top_first_cam_1"};
const string TOPIC_TOP_2_CAM2       {"top_second_cam_1"};
const string TOPIC_TOP_3_CAM2       {"top_third_cam_1"};
